...
namespace NaanBook
{
    ...
    {
        String SqlConnectString = "putstringhere";
        ...
        public DataSet GetDataSetUsingCmdObj(SqlCommand theCommand)
        {
            ...
            myDataAdapter.Fill(myDataSet);
            ds = myDataSet;
            theCommand.CloseConnection();
            return myDataSet;
        }

        public int GetReturnValueUsingCmdObj(SqlCommand theCommand)
        {
          try{
            theComand.Connection = myConnectionSql;
            //SqlDataAdapter myDataAdapter = new SqlDataAdapter(theCommand);
            int valueReturned = theCommand.ExecuteNonQuery();
          }
          catch (Exception ex)
          {
